...
CANON FILE: 03_SYSTEM_ENTITIES/20_ORC__ORCHESTRATORS/02__INDEX_ALL_ORCHESTRATORS
...
OWNER: SYSTEM
ROLE: Canonical navigation law + existence registry + roadmap for all ORC orchestrator families and instances (RAW-ONLY NAV)

CHANGE_NOTE:
- DATE: 2026-01-11
- TYPE: MAJOR
- SUMMARY: "Full rebuild of ORC global index to match actual folder structure; RAW-only nav; strict family block standard; includes Music orchestrators."
- REASON: "Index must be deterministic and compliant with ORC layer rules; existence enforcement."
- IMPACT: "ORC layer navigation/existence becomes strict and audit-compatible."
- CHANGE_ID: UE.CHG.2026-01-11.ORC.IDX.ALL.001
...
**REALM FILE (RAW):** https://raw.githubusercontent.com/pashatyutnev-afk/universe-engine/refs/heads/main/03_SYSTEM_ENTITIES/20_ORC__ORCHESTRATORS/01_CORE_ORCHESTRATORS/00__README__ORCHESTRATORS.md  
...
**REALM FILE (RAW):** https://raw.githubusercontent.com/pashatyutnev-afk/universe-engine/refs/heads/main/03_SYSTEM_ENTITIES/20_ORC__ORCHESTRATORS/10_MUSIC_ORCHESTRATORS/00__README__MUSIC_ORCHESTRATORS.md  
