# 00__INDEX__PROMPT_LIB

SCOPE: Universe Engine  
DOC_TYPE: INDEX (FOLDER)  
STATUS: DRAFT (AUTO-GENERATED)  
DATE: 2026-01-21  
FOLDER: 04_KNOWLEDGE_BASE/30_SHARED_LIBRARIES/60_PROMPT_LIB

---

## PURPOSE
Быстрая навигация по содержимому папки `04_KNOWLEDGE_BASE/30_SHARED_LIBRARIES/60_PROMPT_LIB`.
