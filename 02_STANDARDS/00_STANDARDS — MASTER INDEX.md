# 00_STANDARDS — MASTER INDEX (CANON MAP)
FILE: 02_STANDARDS/00__MASTER_INDEX__UNIVERSE_ENGINE.md

SCOPE: Universe Engine
LAYER: 02_STANDARDS
DOC_TYPE: INDEX
INDEX_TYPE: LAYER_MASTER_REGISTRY
LEVEL: L1
STATUS: ACTIVE
LOCK: FIXED
VERSION: 2.0.0
UID: UE.IDX.STD.MASTER.001
OWNER: SYSTEM
ROLE: Canonical navigation law + existence registry for 02_STANDARDS layer (RAW-ONLY NAV)

CHANGE_NOTE:
- DATE: 2026-01-08
- TYPE: MAJOR
- SUMMARY: "Rebuilt 02_STANDARDS index by actual folder structure: full RAW-only canon map + existence rule."
- REASON: "Нужен индекс для самой папки 02_STANDARDS (что в ней лежит) — детерминированная навигация."
- IMPACT: "02_STANDARDS becomes self-contained: canonical entrypoint + existence registry."
...
Он фиксирует:
- состав папок и документов внутри `02_STANDARDS`
- канонический порядок (нумерация/имена)
- RAW-ONLY навигацию
- правило существования (existence)

---

## 1) EXISTENCE RULE (ABSOLUTE)
- Если документа нет в CANON MAP ниже — он **не существует** для слоя `02_STANDARDS`.
...
## 3) CANON MAP — 02_STANDARDS (RAW-ONLY NAV)
...
09 — INDEX STRUCTURE SPEC
PATH: `02_STANDARDS/01_SPECIFICATIONS/09__INDEX_STRUCTURE_SPEC.md`
...
02 — INDEX TEMPLATE
PATH: `02_STANDARDS/03_TECHNICAL/02__INDEX_TEMPLATE.md`
RAW: https://raw.githubusercontent.com/pashatyutnev-afk/universe-engine/refs/heads/main/02_STANDARDS/03_TECHNICAL/02__INDEX_TEMPLATE.md
...
RAW: https://raw.githubusercontent.com/pashatyutnev-afk/universe-engine/refs/heads/main/02_STANDARDS/05_REQUIREMENTS_TZ/00__INDEX.md
